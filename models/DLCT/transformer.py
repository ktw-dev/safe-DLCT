...
class Transformer(CaptioningModel):
    ...
    def forward(self, regions, boxes, grids,aligns, seq, classes=None, *args):
        ...
        enc_output, mask_enc = self.encoder(regions=regions, grids=grids,boxes=boxes,aligns=aligns, region_embed=region_embed,grid_embed=grid_embed, classes=classes)
        pos = torch.cat([region_embed, grid_embed], dim=1)
    ...
    def step(self, t, prev_output, visual, seq, mode='teacher_forcing', **kwargs):
        ...
        if mode == 'teacher_forcing':
            ...
            if t == 0:
                ...
                self.enc_output, self.mask_enc = self.encoder(regions=visual, grids=grids,boxes=boxes,aligns=aligns, region_embed=self.region_embed,grid_embed=self.grid_embed, classes=classes)
